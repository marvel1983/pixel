      ...
      <div className="group bg-card border border-border rounded-lg hover:shadow-lg hover:-translate-y-0.5 transition-[shadow,transform] duration-150 h-full flex flex-col">
        <div className="relative aspect-[3/4] shrink-0 rounded-t-lg">
          ...
          <div className="absolute inset-0 overflow-hidden rounded-t-lg bg-white">
            {product.imageUrl ? (
              <img src={product.imageUrl.replace("/uploads/", "/uploads/thumb/")} alt={product.name} className="h-full w-full object-contain p-3" loading="lazy" decoding="async" width="204" height="272" />
            ) : (
        ...
        <div className="flex flex-1 flex-col items-center p-3 text-center">
          ...
          <div className="mt-auto flex flex-col gap-3 pt-3 w-full">
            ...
            {loyaltyConfig && (
              <p
                className="tabular-nums text-center text-xs font-medium leading-snug tracking-tight text-emerald-700 dark:text-emerald-400"
