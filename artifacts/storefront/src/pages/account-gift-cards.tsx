...
export default function AccountGiftCardsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <Breadcrumbs crumbs={[{ label: "Account", href: "/account" }, { label: "Gift Cards" }]} />
      <div className="max-w-3xl mx-auto space-y-6">
        <h1 className="text-2xl font-bold tracking-tight flex items-center gap-2">
          <Gift className="h-6 w-6 text-blue-600" /> My Gift Cards
        </h1>
        ...
        <div className="rounded-lg border bg-card">
          ...
          {loading ? (
            ...
            <div className="p-8 text-center text-muted-foreground">No gift cards purchased yet.</div>
          ) : (
