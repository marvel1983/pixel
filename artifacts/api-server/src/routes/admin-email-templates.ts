...
const DEFAULT_TEMPLATES = [
  ...
  { key: "refund_confirmation", name: "Refund Confirmation", subject: "Refund processed for order #{{orderNumber}}", bodyHtml: "<h1>Refund Confirmation</h1><p>Hi {{customerName}},</p><p>A refund of <strong>{{refundAmount}}</strong> has been processed for your order <strong>#{{orderNumber}}</strong>.</p><p><strong>Reason:</strong> {{reason}}</p><p>The refund should appear in your account within 5–10 business days depending on your payment provider.</p><p>If you have any questions, please contact our support team.</p>", variables: ["orderNumber", "customerName", "refundAmount", "reason"], sampleData: { orderNumber: "PC-ABC12345-XY1", customerName: "John Doe", refundAmount: "$49.99", reason: "Customer request" } },
];
